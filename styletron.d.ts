...
declare module "styletron-react" {
  ...
  export class StyletronProvider extends React.Component<PropType, void> {}

  interface StyledComponent<TProps, TElement> extends React.ComponentClass<TProps & React.HTMLAttributes<TElement> & {
    innerRef?: (el: TElement) => any;
  }> {}
  type Style<TProps> = React.CSSProperties | ((props: TProps) => React.CSSProperties);
